...
void melee_actor::load_internal( const JsonObject &obj, const std::string & )
{
    ...
    optional( obj, was_loaded, "throw_message_u", throw_message_u, to_translation( "The force of the %s's attack sends you flying!") );
    optional( obj, was_loaded, "throw_message_npc", throw_message_npc, to_translation( "The force of the %s's attack sends you flying!") );
